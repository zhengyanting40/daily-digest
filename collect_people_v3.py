#!/usr/bin/env python3
"""Scrape people.cn with www and finance subdomains only"""
...
items = []
seen_urls = set()
blacklist = ['人民会客厅', '对话企业家', '更多', '频道', '教育频道', '高考频道']

# www.people.com.cn works (confirmed from debug output)
try:
    html = fetch('http://www.people.com.cn/')
    # n1/ and n2/ patterns with dates
